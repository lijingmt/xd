...
def build_handbook() -> None:
    ...
    guide.bullets(
        [
            "三十本隐藏书共用总掉率30/100000，三十本等概率，单本长期均值仍约1/100000。",
    ...
    guide.callout(
        "三本隐藏书仍与其他职业等概率",
        "全服30本隐藏书共用30/100000总掉率，命中后30本等概率，因此每一本长期均值仍约1/100000。新增职业没有稀释旧职业单本概率。",
        "gold",
    )
    ...
    guide.callout(
        "三本隐藏书与旧职业等概率",
        "全服30本隐藏书共用30/100000总掉率，命中后30本等概率，因此每一本长期均值仍约1/100000。",
        "gold",
    )
    ...
    guide.callout(
        "灵医不是无目标的全图加血器",
        "灵医的服务端智能单疗只在自己与同房间、同逻辑区、同队伍的存活人物中选择生命比例最低者；未组队时只治疗自己。群疗也不作用于路人、异房成员或死亡角色，不提供复活。",
    )
    ...
    guide.table(
        ...
        [
            ...
            ["80+", "慈心普渡 / 回命天露 / 万木新春", "队伍大治疗 / 药契强化急救 / 群疗并逐人净化"],
        ],
        [0.65, 2.65, 2.6],
    )
    guide.callout(
        "新增三本后不稀释旧隐藏书",
        "全服30本隐藏书共用30/100000总掉率，命中后30本等概率，因此每一本长期均值仍约1/100000。三本灵医隐藏书仅能由80级以上灵医学习。",
        "gold",
    )
    guide.h2("5.14.6 灵医15个技能对象全表")
    guide.table(
        ["技能(内部ID)", "形态", "类别", "角色等级门槛", "冷却", "实际定位"],
    ...
    guide.table(
        ...
        [
            ...
            ["总掉率", "30/100000，共30本等概率", "每个队员各掷一次"],
    ...
    guide.h2("8.3 方士/镇越/天象/灵医职业助手与公平付费")
    guide.table(
        ["身份/档位", "职业助手能力", "公平边界"],
        [
    ...
    guide.table(
        ...
        [
            ...
            ["隐藏神技", "十职业各3本、共30本专属神技不在任何商店，只走极低概率掉落"],
    ...
    guide.table(
        ...
        [
            ...
            ["灵医能复活队友吗？", "不能。死亡角色不会进入治疗目标，当前全部治疗技能都没有复活副作用。"],
    ...
    guide.bullets(
        [
            ...
            "灵医智能治疗、净化、药契与全链路回归：lowlib/wapmud2/inherit/feature/fight.pike、test_unit/test_lingyi_profession.pike",
