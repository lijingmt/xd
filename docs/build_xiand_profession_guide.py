...
WUXIANG_MILESTONES = [
    ("解锁前置", "同一账号下剑仙/羽士/诛仙/狂妖/巫妖/影鬼/方士/镇越/天象/灵医10个职业均达到120级后，新建角色时显示无相入口。"),
    ...
    ("30-50级", "无相剑/无相焰补足物理与法术输出；无相净按持续伤害→治疗压制→控制→70级诅咒顺序净化一项；无相壁同房同队短盾。"),
...
TAIJI_MILESTONES = [
    ("解锁前置", "同一账号下 10 职 + 无相均达到 200 级后，新建角色时显示太极入口；是无相之上的最高隐藏职业。"),
