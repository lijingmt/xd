...
DESKTOP_PDF_PATH = Path.home() / "Desktop" / "仙道全职业技能与装备成长手册-十二职业灵医版.pdf"
...
PROFESSIONS = [
    ...
    },
    {
        ...
        "name": "无相",
        "faction": "中立（隐藏）",
        "role": "全职业补位 / 万金油 / 高心法爆发",
        "starter": "wuxiangquan",
        "starter_cn": "无相拳",
        "initial": "生命120 / 法力80 / 力8 / 敏8 / 智8",
        "growth": "力=敏=智=8+1.5L（三系对称）",
        "gear": "全属性中上、生命与法力平衡；可穿任何无职业限制装备",
        "identity": "【隐藏职业】账号下 10 职业均达 120 级解锁。无相心法让最高项的 50% 加成其他两系；120 级后每日一次免疫致命伤。",
    },
    {
        "id": "taiji",
        "name": "太极",
        "faction": "中立（最高隐藏）",
        "role": "生死轮转 / 全职业补位 / 自复活 + 队友复活",
        "starter": "taijiquan",
        "starter_cn": "太极拳",
        "initial": "生命156 / 法力104 / 力10 / 敏10 / 智10",
        "growth": "力=敏=智=10+2.0L（三系对称，比无相强 30%）",
        "gear": "全属性中上、生命与法力平衡；可穿任何无职业限制装备",
        "identity": "【最高隐藏】账号下 10 职+无相均达 200 级解锁。太极心法让最高项的 65% 加成其他两系；生生不息每 5 分钟一次自复活；复阴可主动复活同房同队鬼魂队友。",
    },
]
...
WUXIANG_MILESTONES = [
    ("解锁前置", "同一账号下10个基础职业均达到120级，或共享账号累计捐赠达到3000元后，新建角色时显示无相入口。"),
    ("创建", "选择中立/无相，获得无相拳、无相袍与无相剑；三系对称 8/8/8 起步，生命120/仙力80。"),
    ("1-15级", "无相拳近战，无相诀单体法术，无相医单体回血（治疗比方士低 30%，但满足自救即可）。"),
    ("20级", "完成专属任务，奖励无相灵符（装备后小幅全属性加成，仅无相可穿）。"),
    ("30-50级", "无相剑补足物理输出；无相焰6秒轮转、按可用阶段覆盖2/4/6/8/10个目标且为法术专精60%威力；无相净解一项负面，无相壁提供同房同队短盾。"),
    ("55-70级", "无相唤弱版灵兽（5 分钟存在）；无相雨同房同队群疗；无相击/无相灭进入高阶输出。"),
    ("70级", "实际等级70+怪物进入隐藏技能书资格池；太极·归墟/混元/无极 3 本隐藏书加入全服34本共享池。"),
    ("80级", "可学归墟（被动：心法加成50%→60%）、混元（无相灭强化版，双倍暴击）、无极（无相雨强化版，治疗+50%且净化）。"),
    ("100级", "万象归一解锁：120级专属任务奖励，30秒全属性+30%、5分钟冷却，Boss 关键阶段爆发。"),
    ("120级", "无相化身解锁：每日1次免疫致命伤并恢复25%生命；自杀/切磋/城战/已是鬼魂时不触发。"),
]

TAIJI_MILESTONES = [
    ("解锁前置", "同一账号下10个基础职业与无相均达到200级，或共享账号累计捐赠达到10000元后，新建角色时显示太极入口；是无相之上的最高隐藏职业。"),
    ("创建", "选择中立/太极，获得太极拳、太极袍与太极剑；三系对称 10/10/10 起步，生命156/仙力104（比无相强 30%）。"),
    ("1-15级", "太极拳近战，太极诀单体法术，太极医单体回血（治疗量比无相再强 30%）。"),
    ("20级", "完成专属任务，奖励太极符（装备后小幅全属性加成，仅太极可穿）。"),
    ("30-50级", "太极剑/焰补足物理与法术输出；太极净按持续伤害→治疗压制→控制→70级诅咒顺序净化；太极壁同房同队短盾。"),
    ("55-70级", "太极唤弱版灵兽；太极雨同房同队群疗；太极击/灭进入高阶输出。"),
    ("70级", "实际等级70+怪物进入隐藏技能书资格池；太极·归墟/混元/无极 3 本隐藏书加入全服37本共享池。"),
    ("80级", "可学归墟（被动：心法加成 65%→75%）、混元（太极灭强化版，双倍暴击）、无极（太极雨强化版，治疗+50%且净化）。"),
    ("100级", "太极归真解锁：120级专属任务奖励，30秒全属性+40%、5分钟冷却，比无相万象归一再强 30%。"),
    ("120级", "生生不息就绪：致命伤自动复活，恢复 30% 生命，5 分钟冷却（PVP 可触发）；复阴可主动复活同房同队鬼魂队友。"),
]
...
def parse_skills() -> list[dict[str, object]]:
    ...
    prof_pattern = re.compile(
        r'skill_type\s*\+=\s*\(\{\s*"(jianxian|yushi|zhuxian|kuangyao|wuyao|yinggui|fangshi|zhenyue|tianxiang|lingyi|wuxiang|taiji)"\s*\}\)'
    )
...
def build_handbook() -> None:
        ...
        [
            [
                Paragraph(
                    ...
                    "含34式旧世神技与70式账号绑定太古传承；覆盖任务、副本、队伍、VIP突破与玉石经济",
                    ParagraphStyle(
                        "CoverBox",
                        parent=styles["Body"],
                        fontName="XiandBold",
    ...
    guide.bullets(
        [
            "三十四本隐藏书共用总掉率34/100000，三十四本等概率，单本长期均值仍约1/100000。",
    ...
    guide.callout(
        "三本隐藏书仍与其他职业等概率",
        "全服34本隐藏书共用34/100000总掉率，命中后34本等概率，因此每一本长期均值仍约1/100000。新增技能没有稀释旧职业单本概率。",
        "gold",
    )
    ...
    guide.callout(
        "三本隐藏书与旧职业等概率",
        "全服34本隐藏书共用34/100000总掉率，命中后34本等概率，因此每一本长期均值仍约1/100000。",
        "gold",
    )
    ...
    guide.callout(
        "新增第四本灵医神技后不稀释旧隐藏书",
        "全服34本隐藏书共用34/100000总掉率，命中后34本等概率，因此每一本长期均值仍约1/100000。四本灵医隐藏书仅能由80级以上灵医学习。",
        "gold",
    )
    ...
    # 5.15 Wuxiang
    guide.pagebreak()
    guide.h1("5.15 无相重点：中立隐藏全职业")
    guide.callout(
        "无相不是数值怪物，是工具箱",
        "每个属性都略输专精职业（85% 均值），但拥有近战/法术/治疗/增益/防御/净化/召唤/终极八大类共 17 个技能。价值来自「同时拥有」的灵活度，而非单点强度。任何专精玩家在自身领域都不应被无相超越。",
    )
    guide.h2("5.15.1 创建、属性与装备")
    guide.table(
        ["阵营", "起手技能", "创建属性", "升级公式", "装备优先级"],
        [[
            PROF_BY_ID["wuxiang"]["faction"],
            PROF_BY_ID["wuxiang"]["starter_cn"],
            PROF_BY_ID["wuxiang"]["initial"],
            PROF_BY_ID["wuxiang"]["growth"],
            PROF_BY_ID["wuxiang"]["gear"],
        ]],
        [0.6, 0.8, 1.45, 1.55, 1.8],
        compact=True,
    )
    guide.bullets(
        [
            "解锁条件：账号下剑仙/羽士/诛仙/狂妖/巫妖/影鬼/方士/镇越/天象/灵医 10 个职业均达到 120 级；服务端实时查账号角色清单，选项不满足时隐藏且不可伪造。",
            "生命120、仙力80、力量/敏捷/智力各 8 起步；三系对称成长 8+floor((等级-1)×1.5)，120 级达到 187/187/187，200 级达到 307/307/307。",
            "初始装备：无相袍（防具，1 级可穿，防御平庸）+ 无相剑（武器，1 级可拿，攻击平庸）；可销毁/可丢弃/可交易，不会误覆盖后期装备。",
            "可穿戴：通用新手装、third 中立装、所有未限定职业的装备；不可穿戴：职业绑定专属（灵医饰物、镇越战刃、剑仙专属等）。",
        ]
    )
    guide.h2("5.15.2 0到高阶里程碑")
    guide.table(
        ["阶段", "能力与行动"],
        [list(row) for row in WUXIANG_MILESTONES],
        [0.9, 4.5],
    )
    guide.h2("5.15.3 无相心法与化身边界")
    guide.table(
        ["机制", "服务器规则", "使用方式", "安全边界"],
        [
            ["无相心法", "取当前最高单项属性（力/敏/智）的 50% 加成另外两系", "实时结算，无需手动触发；最高项200/其他100时，实际作用相当于全200", "不入存档、不参与装备穿戴门槛、不参与技能学习前置；死亡/登出/换房不影响（即时计算）"],
            ["万象归一", "100 级任务奖励的主动技能，30 秒全属性 +30%", "Boss 关键阶段爆发使用", "5 分钟冷却；爆发期总属性仍不超过专精满级基线"],
            ["无相化身", "120 级解锁的被动：每日免疫 1 次致命伤", "致命伤自动触发，无需手动操作", "恢复 25% 生命；自杀/切磋/城战/已是鬼魂不触发；与VIP无关、与灵医复苏独立计数"],
            ["净化顺序", "持续伤害 → 治疗压制 → 控制 → 70 级诅咒", "无相净按此优先级净化一项", "每次只解一类；先结算当前减疗再治疗"],
            ["治疗压制", "受到的减疗效果最多按 90% 计算", "高减疗场景保底", "正常治疗/净化流程不受影响；没有有效治疗/净化不扣法力与冷却"],
            ["输出上限", "单次物理/法术动作不超过专精等阶技能的 85%", "15+ 技能自由组合兜底", "群攻同房敌对目标；受PVP/Boss/宠物伤害封顶约束"],
            ["无限反射/无敌/百分比伤害/远程效果", "全部禁止", "—", "防止数值爆炸和卡顿；玩家/Boss 各有上限"],
        ],
        [0.7, 2.0, 1.65, 2.0],
        compact=True,
    )
    guide.h2("5.15.4 普通与每日高级技能书")
    guide.h3("普通技能书")
    guide.table(
        ["等级", "技能书", "书ID", "价格", "入口"],
        book_rows(books_by_prof["wuxiang"], advanced=False),
        [0.45, 1.55, 1.35, 1.2, 1.15],
        compact=True,
    )
    guide.h3("60级以上每日轮换")
    guide.table(
        ["等级", "技能书", "书ID", "价格", "入口"],
        book_rows(books_by_prof["wuxiang"], advanced=True),
        [0.45, 1.55, 1.35, 1.2, 1.15],
        compact=True,
    )
    guide.h2("5.15.5 专属任务与隐藏传承")
    guide.table(
        ["等级", "任务路线", "奖励/作用"],
        [
            ["20", "无相入门·万象初判", "无相灵符；仅无相可穿，提供少量全属性加成"],
            ["80+", "太极·归墟 / 太极·混元 / 太极·无极", "心法上限 60% / 无相灭双倍暴击 / 无相雨治疗+50%并净化"],
            ["100", "120级专属任务（NPC=无相教师）", "万象归一技能书；30秒全属性+30%，5分钟冷却"],
            ["120", "无相化身被动", "每日1次免疫致命伤并恢复25%生命"],
        ],
        [0.65, 2.65, 2.6],
    )
    guide.callout(
        "全服34本隐藏书共享34/100000总掉率",
        "归墟/混元/无极 3 本无相隐藏书加入全服池后，池子从 31 本扩到 34 本，共享分子同步从 31/100000 扩到 34/100000，每本长期均值仍约 1/100000；无相隐藏书仅能由 80 级以上无相学习。",
        "gold",
    )
    guide.h2("5.15.6 无相全部技能对象全表")
    guide.table(
        ["技能(内部ID)", "形态", "类别", "角色等级门槛", "冷却", "实际定位"],
        skill_rows(skills_by_prof["wuxiang"]),
        [1.8, 0.55, 0.95, 1.1, 0.7, 2.5],
        compact=True,
    )
    ...
    # 5.16 Taiji
    guide.pagebreak()
    guide.h1("5.16 太极重点：最高隐藏·生死轮转")
    guide.callout(
        "太极是无相之上的最高隐藏职业",
        "比无相综合实力强 30%（三系基线 10、生命 156、成长 2.0/级）。太极心法把最高项的 65% 加成另外两系；生生不息每 5 分钟可触发一次自复活（PVP 可用）；复阴是主动技能，独立 5 分钟冷却，复活同房同队鬼魂队友。",
    )
    guide.h2("5.16.1 创建、属性与装备")
    guide.table(
        ["阵营", "起手技能", "创建属性", "升级公式", "装备优先级"],
        [[
            PROF_BY_ID["taiji"]["faction"],
            PROF_BY_ID["taiji"]["starter_cn"],
            PROF_BY_ID["taiji"]["initial"],
            PROF_BY_ID["taiji"]["growth"],
            PROF_BY_ID["taiji"]["gear"],
        ]],
        [0.6, 0.8, 1.45, 1.55, 1.8],
        compact=True,
    )
    guide.bullets(
        [
            "解锁条件：账号下剑仙/羽士/诛仙/狂妖/巫妖/影鬼/方士/镇越/天象/灵医 10 个职业 + 无相，全部达到 200 级；服务端实时查账号角色清单，选项不满足时隐藏且不可伪造。",
            "生命156、仙力104、力量/敏捷/智力各 10 起步；三系对称成长 10+floor((等级-1)×2.0)，120 级达到 248/248/248，200 级达到 408/408/408。",
            "初始装备：太极袍（防具，1 级可穿）+ 太极剑（武器，1 级可拿）；可销毁/可丢弃/可交易。",
            "可穿戴规则同无相：通用新手装 + third 中立装 + 所有未限定职业的装备；不可穿戴职业绑定专属。",
        ]
    )
    guide.h2("5.16.2 0到高阶里程碑")
    guide.table(
        ["阶段", "能力与行动"],
        [list(row) for row in TAIJI_MILESTONES],
        [0.9, 4.5],
    )
    guide.h2("5.16.3 太极心法、生生不息与复阴边界")
    guide.table(
        ["机制", "服务器规则", "使用方式", "安全边界"],
        [
            ["太极心法", "取当前最高单项属性的 65% 加成另外两系", "实时结算，无需手动触发；最高项200/其他100时，实际作用相当于全229", "不入存档、不参与装备门槛/技能前置；vs 无相 50% 强 30%"],
            ["生生不息", "致命伤自动复活，5 分钟冷却（timestamp）", "战斗中被秒杀时自动触发；PVP 也可触发", "恢复 30% 生命；自杀/切磋/已是鬼魂不触发；与无相化身每日冷却互不干扰"],
            ["复阴", "主动技能：复活同房同队鬼魂队友，独立 5 分钟冷却", "命令 taiji_fuyin <队友名> 或在教师处点击链接", "目标必须是同房同队的鬼魂玩家；恢复 50% 生命；不能复活自己"],
            ["太极归真", "100 级任务奖励的主动技能，30 秒全属性 +40%", "Boss 关键阶段爆发", "5 分钟冷却；比无相万象归一(+30%) 强 10 个百分点"],
            ["净化顺序", "持续伤害 → 治疗压制 → 控制 → 70 级诅咒", "太极净按此优先级净化一项", "每次只解一类；同无相"],
            ["输出上限", "单次物理/法术动作约为专精等阶技能的 110%", "17 个技能覆盖近战/法术/治疗/增益/防御/净化/召唤/终极", "群攻同房敌对；受PVP/Boss/宠物伤害封顶约束"],
        ],
        [0.7, 2.0, 1.65, 2.0],
        compact=True,
    )
    guide.h2("5.16.4 普通与每日高级技能书")
    guide.h3("普通技能书")
    guide.table(
        ["等级", "技能书", "书ID", "价格", "入口"],
        book_rows(books_by_prof["taiji"], advanced=False),
        [0.45, 1.55, 1.35, 1.2, 1.15],
        compact=True,
    )
    guide.h3("60级以上每日轮换")
    guide.table(
        ["等级", "技能书", "书ID", "价格", "入口"],
        book_rows(books_by_prof["taiji"], advanced=True),
        [0.45, 1.55, 1.35, 1.2, 1.15],
        compact=True,
    )
    guide.h2("5.16.5 专属任务与隐藏传承")
    guide.table(
        ["等级", "任务路线", "奖励/作用"],
        [
            ["20", "太极入门·阴阳初判", "太极符；仅太极可穿，提供少量全属性加成"],
            ["80+", "太极·归墟 / 太极·混元 / 太极·无极", "心法上限 75% / 太极灭双倍暴击 / 太极雨治疗+50%并净化"],
            ["100", "120级专属任务（NPC=太极仙子）", "太极归真技能书；30秒全属性+40%，5分钟冷却"],
            ["120", "生生不息被动就绪", "致命伤自动复活，恢复30%生命，5分钟冷却（PVP可触发）"],
            ["120", "复阴主动技能就绪", "命令 taiji_fuyin <队友名> 复活同房同队鬼魂，独立5分钟冷却"],
        ],
        [0.65, 2.65, 2.6],
    )
    guide.callout(
        "全服37本隐藏书共享37/100000总掉率",
        "归墟/混元/无极 3 本太极隐藏书加入全服池后，池子从 34 本扩到 37 本，共享分子同步从 34/100000 扩到 37/100000，每本长期均值仍约 1/100000；太极隐藏书仅能由 80 级以上太极学习。",
        "gold",
    )
    guide.h2("5.16.6 太极全部技能对象全表")
    guide.table(
        ["技能(内部ID)", "形态", "类别", "角色等级门槛", "冷却", "实际定位"],
        skill_rows(skills_by_prof["taiji"]),
        [1.8, 0.55, 0.95, 1.1, 0.7, 2.5],
        compact=True,
    )
    ...
    guide.table(
        ...
        [
            ...
            ["总掉率", "34/100000，共34本等概率", "每个队员各掷一次"],
    ...
    guide.callout(
        "比旧隐藏书再稀有约一百倍",
        "太古传承只由实际等级90级以上怪物触发独立掉落判定。70式总权重390，分母125000000；总池概率约为旧34本隐藏池的1/100。每职业固定7式，品阶1至7权重依次为12/9/7/5/3/2/1，越高阶越稀有。",
        "gold",
    )
    guide.table(
        ["职业", "七式太古传承（由常见到极稀有）"],
    ...
    guide.bullets(
        [
            ...
            "旧34本隐藏书继续保持原掉率、原流通与原学习规则，新太古池不稀释旧池。",
        ]
    )
    ...
    guide.table(
        ...
        [
            ...
            ["隐藏神技", "旧池34本保持原规则；另有每职业7本、共70本拾取即账号绑定的太古传承，实际等级90+怪极低概率独立掉落"],
    ...
    guide.table(
        ...
        [
            ...
            ["为什么70级没掉隐藏书？", "70级只进入旧34本资格池，单本长期均值约1/100000；新太古书要求怪物实际等级90+，且总池约再低100倍。"],
            ["太古技能书为什么不能交易？", "新70本在拾取时绑定注册账号，并禁用丢弃、交易、赠送和仓库存取；这是与旧34本可流通隐藏书并存的独立规则。"],
