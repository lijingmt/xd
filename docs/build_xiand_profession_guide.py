...
def build_handbook() -> None:
    ...
    guide.callout(
        "先记住一条主线",
        "创建人物 -> 穿好基础装备 -> 买到技能书 -> 在背包点击学习 -> 实战积累熟练度 -> 按等级更新装备 -> 60级进入每日进阶书 -> 70级挑战高阶动态怪 -> 80级学习极稀有隐藏神技。",
    )
    guide.paragraph(
    ...
    guide.bullets(
        [
            "打开 newbie_guide 查看人物真实状态；它不会因为点过按钮就伪装完成。",
    ...
    guide.table(
        ["系统", "入口/命令", "核心价值", "成长建议"],
        [
            ["新手引导", "newbie_guide", "检查真实装备与技能状态", "每次达到职业里程碑后重新查看"],
