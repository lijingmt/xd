...
WUXIANG_MILESTONES = [
    ...
    ("30-50级", "无相剑补足物理输出；无相焰3秒轮转、按可用阶段覆盖2/4/6/8/10个目标且为法术专精60%威力；无相净解一项负面，无相壁提供同房同队短盾。"),
    ...
    ("100级", "万象归一解锁：100级专属任务奖励，30秒全属性+30%、5分钟冷却，Boss 关键阶段爆发。"),
...
def build_handbook() -> None:
    ...
    guide.table(
        ...
        [
            ...
            ["100", "100级专属任务（NPC=无相教师）", "万象归一技能书；30秒全属性+30%，5分钟冷却"],
