...
DESKTOP_PDF_PATH = Path.home() / "Desktop" / "仙道全职业技能与装备成长手册-十一职业灵医版.pdf"
...
def parse_skills() -> list[dict[str, object]]:
    ...
    prof_pattern = re.compile(
        r'skill_type\s*\+=\s*\(\{\s*"(jianxian|yushi|zhuxian|kuangyao|wuyao|yinggui|fangshi|zhenyue|tianxiang|lingyi|wuxiang)"\s*\}\)'
    )
