...
def build_handbook() -> None:
    ...
    story.append(
        Paragraph(
            "从创建人物到 500+ 境界 · 七职业全覆盖 · 方士重点与最新平衡版",
            styles["CoverSub"],
        )
    )
    ...
    guide.callout(
        "狂妖三神技已按高属性版本重做",
        "血魔噬界五段为武器伤害+60%/70%/80%/90%/100%，并附加3600/4900/6500/8500/11200物理伤害；修罗狂意12秒提高20%至60%总物攻；血海裂伤完整持续对普通目标累计约6%/6.72%/7.56%/8.28%/9%最大生命真实伤害，对Boss整段最多约3%。",
        "gold",
    )
    ...
    guide.bullets(
        [
            ...
            "重点回归：test_unit/test_combat_balance.pike、test_autofight_system.pike、test_player_save_safety.pike、test_admin_level_management.pike",
