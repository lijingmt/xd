...
def build_skill_guide() -> None:
    ...
    guide.table(
        ...
        [
            ...
            ["物理/法术穿透", "最多削减60%目标防御或抗性", "穿透不是无视全部防御，也不等于真实伤害"],
    ...
    for profession_id in [
        ...
        if profession_id == "jianxian":
            ...
            guide.callout(
                "狂妖最新精确边界",
                "血魔噬界五段附加3600/4900/6500/8500/11200物理伤害，并提高60%至100%武器伤害；修罗狂意12秒提高20%至60%总物攻；血海裂伤整段对普通目标约为最大生命6%至9%，对Boss整段最多约3%。",
                "gold",
            )
    ...
    guide.table(
        ...
        [
            ...
            ["血海裂伤12秒会掉24%吗？", "不会。普通目标整段约6%-9%，Boss整段最多约3%，冷却120秒。"],
        ],
        [1.7, 4.0],
    )
