...
- 分支：`feat/new-moon-profession-equipment`
- 内容基线：`082d4ac888`
- 生成日期：2026-08-14
- 数据规模：12 个职业，290 个职业技能对象，277 条职业技能书配置，15 种公开山海异兽 + 1 只隐藏鸾鸟
...
| 无相 | 中立（隐藏） | 全职业补位 / 万金油 / 高心法爆发 | 【隐藏职业】账号下 10 职业均达 120 级解锁。无相心法让最高项的 50% 加成其他两系；120 级后每日一次免疫致命伤。 |
| 太极 | 中立（最高隐藏） | 生死轮转 / 全职业补位 / 自复活 + 队友复活 | 【最高隐藏】账号下 10 职+无相均达 200 级解锁。太极心法让最高项的 65% 加成其他两系；生生不息每 5 分钟一次自复活；复阴可主动复活同房同队鬼魂队友。 |
...
> **版本声明**
>
> 本文生成于 2026-08-14，分支 feat/new-moon-profession-equipment，内容基线 082d4ac888。活动、每日轮换、库存、价格和运营开放范围以服务器当日界面为准。
