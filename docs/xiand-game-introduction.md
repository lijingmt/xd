...
十一职业并行成长 · 山海万灵陪伴 · 组队与长期收藏

- 分支：`feat-timed-pvp-pve-events`
- 内容基线：`554a767087`
- 生成日期：2026-08-04
- 数据规模：10 个职业，256 个职业技能对象，253 条职业技能书配置，15 种公开山海异兽 + 1 只隐藏鸾鸟
...
| 核心支柱 | 玩家获得的体验 | 代表系统 |
| --- | --- | --- |
| 职业差异 | 坦克、治疗、召唤、法术、物理爆发和持续伤害都有独立循环 | 十一职业、职业任务、隐藏技能 |
...
- 十一职业合计拥有31本极稀有隐藏大神技能书，只从实际等级70级以上怪物的资格池掉落，不在商店出售。
...
| xiand-all-professions-skill-guide.pdf | 十一职业全部技能、隐藏技能、书籍来源与学习条件 |
...
> **版本声明**
>
> 本文生成于 2026-08-04，分支 feat-timed-pvp-pve-events，内容基线 554a767087。活动、每日轮换、库存、价格和运营开放范围以服务器当日界面为准。
