...
string net_dead()
{
	...
	//out+="</html>";
	out+="</body><script src=\"includes/translate.js\"></script><script>translate.language.setLocal('chinese_simplified'); translate.service.use('client.edge'); translate.setAutoDiscriminateLocalLanguage();translate.execute();</script><script src=\"includes/game-number-format.js\"></script></html>";
	//out+="</body></html>";
	input=({});
	string o=out;
	out="";
