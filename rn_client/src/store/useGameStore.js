...
export const useGameStore = create((set, get) => ({
  ...
  accountUnlocks: { wuxiang: false, taiji: false, zhaoming: false,
    wuji_entitled: false, wuxin_entitled: false,
    wuxin_difficulty_ready: false },
  afkBusy: false,
  recovering: false,
  currentCharacterId: '',
  networkOnline: true,
  ...
  applyAccountData(data) {
    ...
    set({
      ...
      accountUnlocks: {
        ...
        wuji_entitled: !!data.wuji_entitled,
        wuxin_entitled: !!data.wuxin_entitled,
        wuxin_difficulty_ready: !!data.wuxin_difficulty_ready,
      },
    });
  },
