            ...
            patchAnnouncements: [
                {
                    ...
                    date: '9月1日',
                    icon: '🔧',
                    title: '仙道 · 9月1日修复与便利更新',
                    subtitle: '仓库解卡 · 洗炼不脱装 · 难度驱动怪物 · 同房组队',
                    sections: [
                        { h: '一、仓库与装备修复', items: [
                            '共享仓库"重复装备"锁死改为自动解锁：会话中出现两端同ID时自动清理角色仓库影子，偶发仓库异常同源修复',
                            '批量直存/取回的恢复逻辑改为以在线人物为准，杜绝落盘竞态造成的错位',
                            '仓库存取页新增【尾页】直达按钮（关键词搜索本就支持）',
                            '洗炼装备不再被脱下：炼化产物自动穿回原槽位',
                            '数值校正更精准：玩家正常打出/洗炼的装备不会被误回收；确需校正时保留原值截到线（不再几千变+1）'
                        ]},
                        { h: '二、怪物强度与难度', items: [
                            '怪物生命改为难度驱动：基础难度保持世代2%软强度，提升难度后恢复设计满血',
                            '修复0血/1血怪打不死也逃不掉的问题（永远不会再出现0血怪）',
                            '修复偶发几十万血的超标怪',
                            '切换难度不再限定主城/幻境入口：任意地图、脱战且停止挂机即可（冷却不变）'
                        ]},
                        { h: '三、便利功能', items: [
                            '新增【邀请同房间所有人】一键组队（队伍邀请页入口）',
                            '七彩八卦炉：已装备置顶并带【已装备】标识，新增15部位筛选',
                            '新增一键摧毁低级书卷：需求等级低于人物30级的技能书/配方/图纸/卷轴可批量清理（预览+确认）',
                            '冰蓝玉石/紫金玉石/绿松石/尖晶石/青金石补齐叠加（上限9999，掉落自动合并）',
                            '智能穿装评分修正：不再一味选高等级白板，属性好坏重新占主导',
                            '在线列表/传送排序：同账号角色置顶、好友次之（分组显示）'
                        ]},
                        { h: '四、战斗与套装平衡（9月1日追加）', items: [
                            '群攻伤害提升至单体的85%，Boss单跳上限提高至其血量8%（原先群攻打Boss被压到约1/4）',
                            '太极群攻基础威力上调并保持高于无相',
                            'Boss血量翻倍（倍率2→4）：小怪强度不变，首领重新有挑战感',
                            '套装分档加成全面重做：随装备等级成长并按套装阶位（新月→寰极）加倍，300级寰极满套全属性约+7800',
                            '太极/无相心法加成现在会显示在人物面板（战斗结算一直生效）'
                        ]},
                        { h: '五、支付兼容', items: [
                            '在线上限/职业人物位/幻境人物位扩充支持背包玉石补足：默认优先扣账号共享碎玉，不足自动用当前人物背包玉折算'
                        ]}
                    ]
                },
                {
